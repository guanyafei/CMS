            ...
            <div class="list cell">
              <template>
                <div 
                  ...
                  <sn-checkbox v-for="(channelItem,index) in channel.channels" :key='index' v-if ="channel.channelType == channelItem.channelType"
                    v-model="innerChannelSelectedIds"
                    :label="channelItem.channelId"
                    :disabled="findInDisabled(channelItem.channelId)"
                    @change="handleChange">
