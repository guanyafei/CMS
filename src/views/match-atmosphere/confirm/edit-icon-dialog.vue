<template>
  <sn-confirm title="编辑icon" txt :flag="matchIconFlagEdit">
    <sn-form ref="commonFloor" :model="editFloorInfo" :rules="floorRules" label-width="140px" formWidth="600">
      ...
      <time-range :startTime="startTime" :endTime="endTime" :disabled="true"></time-range>
...
export default {
  name: 'EditIconDialog',
  props: ['matchIconFlagEdit', 'skinId'],
  components: {
    ActName,
    TimeRange
  },
  ...
  methods: {
    ...
    cancelIconBtn() {
      ...
      this.$emit('update:matchIconFlagEdit', false);
      this.activityName = '';
      this.startTime = '';
      this.endTime = '';
      this.fileShowName = '';
