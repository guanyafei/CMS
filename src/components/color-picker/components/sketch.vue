  ...
  <div :class="['vc-sketch', disableAlpha ? 'vc-sketch__disable-alpha' : '']">
    <div class="vc-sketch-work-wrap">
      ...
      <div class="vc-sketch-field" v-if="!disableFields">
        ...
        <div class="vc-sketch-btns">
          <sn-button
            type="outline"
            size="mini"
            :circle="false"
            @click="closePickerPropper"
            :style="btnStyle"
          >确认</sn-button>
        </div>
      </div>
    ...
    <div class="vc-sketch-presets" v-if="false">
...
export default {
  ...
  methods: {
    closePickerPropper () {
      this.dispatch('SnColorPicker', 'closePickerPropper', this)
    },
    handlePreset (c) {
      this.colorChange({
        hex: c,
