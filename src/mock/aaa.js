  ...
  var e = {
      render: function() {
        var e = this,
          t = e.$createElement,
          n = e._self._c || t;
        return n('transition', { attrs: { appear: '', name: 'v-img-fade' } }, [
          e.closed
            ? e._e()
            : n(
                'div',
                  ...
                  e.thumbnails && e.images.length > 1
                    ? n(
                        ...
                        e._l(e.images, function(t, i) {
                          return n('img', {
                            key: i,
                            class: { 'is-selected': e.currentImageIndex == i },
                            attrs: { src: t },
                            on: {
                              click: function(t) {
                                e.select(i);
      ...
      function t(t) {
        ...
        (this._invoke = function(e, t) {
          return new Promise(function(i, s) {
            var r = { key: e, arg: t, resolve: i, reject: s, next: null };
    ...
    i = function(e, t, n) {
      ...
      return (
        ...
        void 0 !== t.value &&
          ...
          (r = t.value.src || r),
          (c = t.value.title || c),
          (l.opened = t.value.opened),
          (l.closed = t.value.closed),
          (l.changed = t.value.changed),
          void 0 !== t.value.sourceButton && (s = t.value.sourceButton),
          void 0 !== t.value.thumbnails && (u = t.value.thumbnails)),
        e.setAttribute('data-vue-img-src', r),
        a && e.setAttribute('data-vue-img-group', a),
        c && e.setAttribute('data-vue-img-title', c),
        s && e.setAttribute('data-vue-img-source-button', s),
        u && e.setAttribute('data-vue-img-thumbnails', u),
        r || console.error('v-img element missing src parameter.'),
        (e.style.cursor = i),
        {
          cursor: i,
          src: r,
    ...
    a = function(a, o) {
      var s = a.extend(e);
      (o = t(
        { altAsTitle: !1, sourceButton: !1, thumbnails: !1, openOn: 'click' },
        o
      )),
        a.directive('img', {
          update: function(e, t, n, a) {
            ...
            a.data.attrs &&
              n.data.attrs &&
              ((r = a.data.attrs.src !== n.data.attrs.src),
              o.altAsTitle && (s = a.data.attrs.alt !== n.data.attrs.alt));
          ...
          bind: function(e, t) {
            ...
            if (!c) {
              ...
              u.setAttribute('id', 'imageScreen'),
                document.querySelector('body').appendChild(u),
                (c = window.vueImg = new s().$mount('#imageScreen'));
            }
            e.addEventListener(r.openOn, function() {
              var t = void 0;
              (t = e.dataset.vueImgGroup
                ? [].concat(
                    n(
                      document.querySelectorAll(
                        'img[data-vue-img-group="' +
                          e.dataset.vueImgGroup +
                          '"]'
                      )
                    )
                  )
                ...
                a.set(c, 'thumbnails', 'true' === e.dataset.vueImgThumbnails),
                a.set(c, 'currentImageIndex', t.indexOf(e)),
                a.set(c, 'handlers', r.events),
                a.set(c, 'closed', !1);
            });
          }
        });
